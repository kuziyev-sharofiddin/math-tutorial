        ...
        <div class="content-header row mb-6">
            <div class="content-header-left col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-4">Leaders</h2>
                ...
                <div class="table-responsive">
                    <table id="categories_datatable"
                        ...
                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="w-225px sorting" tabindex="0" aria-controls="categories_datatable" rowspan="1"
                                colspan="1" aria-label="Nomi: activate to sort column ascending"
                                style="width: 225.25px;">Full Name</th>
                            <th class="w-225px sorting" tabindex="0" aria-controls="categories_datatable" rowspan="1"
                                colspan="1" aria-label="Nomi: activate to sort column ascending"
                                style="width: 225.25px;">Position</th>
                            <th class="w-225px sorting" tabindex="0" aria-controls="categories_datatable" rowspan="1"
                                colspan="1" aria-label="Nomi: activate to sort column ascending"
                        ...
                        @foreach($leaders as $leader)
                            <tr class="even">
                                <td>{{$leader->id}}</td>
                                <td class="sorting_1"><img class=" img-thumbnail w-50px h-50px" src="{{$leader->getImageUrl() }}"
                                                           alt="photo"></td>
                                <td>{{$leader->title}}</td>
                                ...
                                <td>
                                    <div class="text-end">
                                        <div class="btn-group">
                                            <a href="{{route('leaders.edit', ['leader'=> $leader->id])}}"
                                               class="btn btn-success px-4 btn-sm kt_modal_stacked_edit">
                                                <i class="bi bi-pencil p-0"></i>
                                            </a>
                                            <form action="{{ route('leaders.destroy', ['leader' => $leader->id]) }}" method="POST" style="display: inline;">
                                                @csrf
                                                @method('DELETE')
