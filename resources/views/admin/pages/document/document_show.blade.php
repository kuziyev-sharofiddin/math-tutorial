        ...
        <div class="content-header row mb-6">
            <div class="content-header-left col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-4">Documents</h2>
                ...
                <div class="table-responsive">
                    <table id="categories_datatable"
                        ...
                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="w-225px sorting" tabindex="0" aria-controls="categories_datatable" rowspan="1"
                                colspan="1" aria-label="Nomi: activate to sort column ascending"
                                style="width: 225.25px;">Decision Number Date</th>
                            <th class="w-225px sorting" tabindex="0" aria-controls="categories_datatable" rowspan="1"
                                colspan="1" aria-label="Nomi: activate to sort column ascending"
                                style="width: 225.25px;">Url</th>
                            <th class="w-225px sorting" tabindex="0" aria-controls="categories_datatable" rowspan="1"
                                colspan="1" aria-label="Nomi: activate to sort column ascending"
                                style="width: 225.25px;">Tag</th>
                        ...
                        @foreach($documents as $document)
                            <tr class="even">
                                <td>{{$document->id}}</td>
                                <td>{{$document->getTranslation('title', app()->getLocale())}}</td>
                                <td>{{$document->getTranslation('decision_number_date', app()->getLocale())}}</td>
                                <td>{{$document->url}}</td>
                                <td>{{$document->tag}}</td>
                                <td>
                                    <div class="text-end">
                                        <div class="btn-group">
                                            ...
                                            <form action="{{ route('document.destroy', ['document' => $document->id]) }}" method="POST" style="display: inline;">
                                                @csrf
                                                @method('DELETE')
