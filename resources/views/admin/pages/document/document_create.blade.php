        ...
        <div class="card card-flush p-10">
            <form id="kt_docs_formvalidation_text" class="form fv-plugins-bootstrap5 fv-plugins-framework" method="POST"
                ...
                <div class="fv-row mb-10 row fv-plugins-icon-container">
                    ...
                    <div class="col-7">
                        <input type="text" name="title_crl" value="{{old('title_crl')}}"
                               class="form-control form-control-solid mb-3 mb-lg-0">
                        <div class="fv-plugins-message-container invalid-feedback">
                        </div>
                    </div>
                ...
                <div class="fv-row mb-10 row fv-plugins-icon-container">
                    ...
                    <div class="col-7">
                        <input type="text" name="decision_number_date_uz" value="{{old('decision_number_date_uz')}}"
                               class="form-control form-control-solid mb-3 mb-lg-0">
                        <div class="fv-plugins-message-container invalid-feedback">
                        </div>
                    </div>
                ...
                <div class="fv-row mb-10 row fv-plugins-icon-container">
                    ...
                    <div class="col-7">
                        <input type="text" name="decision_number_date_ru" value="{{old('decision_number_date_ru')}}"
                               class="form-control form-control-solid mb-3 mb-lg-0">
                        <div class="fv-plugins-message-container invalid-feedback">
                        </div>
                    </div>
                ...
                <div class="fv-row mb-10 row fv-plugins-icon-container">
                    ...
                    <div class="col-7">
                        <input type="text" name="decision_number_date_crl" value="{{old('decision_number_date_crl')}}"
                               class="form-control form-control-solid mb-3 mb-lg-0">
                        <div class="fv-plugins-message-container invalid-feedback">
                        </div>
                    </div>
